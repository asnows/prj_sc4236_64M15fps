...
#define IMAGE_HSIZE					0xf00
#define IMAGE_VSIZE					0x360

#define  VDMA_VIDEOSTR_BASE_ADDR    0x43000000
#define  VDMA_IMGCAP0_BASE_ADDR     0x43010000
#define  VDMA_ImgCopy_BASE_ADDR     0x43020000
#define  VDMA_IMGCAP1_BASE_ADDR     0x43030000
#define  VDMA_IMGCAP2_BASE_ADDR     0x43040000
...
void vdma_init(unsigned int baseAddr, unsigned int imgAddr)
{

	Xil_Out32(baseAddr+S2MM_VDMACR_OFSET,0x8b);
	Xil_Out32(baseAddr+S2MM_START_ADDRESS1_OFSET,imgAddr);
	Xil_Out32(baseAddr+S2MM_FRMDLY_STRIDE_OFSET,IMAGE_HSIZE);
	Xil_Out32(baseAddr+S2MM_HSIZE_OFSET,IMAGE_HSIZE);
	Xil_Out32(baseAddr+S2MM_VSIZE_OFSET,IMAGE_VSIZE);
...
{
	unsigned int ImgCap0_Addr = 0x17000000;
	unsigned int ImgCap1_Addr = 0x17050000;
	unsigned int ImgCap2_Addr = 0x170a0000;

	vdma_init(VDMA_IMGCAP0_BASE_ADDR,ImgCap0_Addr);
	vdma_init(VDMA_IMGCAP1_BASE_ADDR,ImgCap1_Addr);
	vdma_init(VDMA_IMGCAP2_BASE_ADDR,ImgCap2_Addr);
...
{
	unsigned int ImgCap0_Addr = 0x16000000;
	unsigned int ImgCap1_Addr = 0x16050000;
	unsigned int ImgCap2_Addr = 0x160a0000;
	unsigned int ImgCap3_Addr = 0x160F0000;

	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_VDMACR_OFSET,0x8b);

	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_START_ADDRESS1_OFSET,ImgCap0_Addr);
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_START_ADDRESS2_OFSET,ImgCap1_Addr);
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_START_ADDRESS3_OFSET,ImgCap2_Addr);
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_START_ADDRESS4_OFSET,ImgCap3_Addr);

	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_FRMDLY_STRIDE_OFSET,IMAGE_HSIZE);
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_HSIZE_OFSET,IMAGE_HSIZE);
	Xil_Out32(VDMA_VIDEOSTR_BASE_ADDR+S2MM_VSIZE_OFSET,IMAGE_VSIZE);
