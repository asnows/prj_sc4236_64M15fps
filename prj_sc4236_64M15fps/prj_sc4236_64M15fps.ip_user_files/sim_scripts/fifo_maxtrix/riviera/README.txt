...
#
# Generated by export_simulation on Fri Mar 29 08:59:59 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './fifo_maxtrix.sh' script.

./fifo_maxtrix.sh -reset_run
...
./fifo_maxtrix.sh -noclean_files

For more information on the script, please type './fifo_maxtrix.sh -help'.
