...
HD_PWD='E:/WorkSpace/project/FPGA/prj_sc4236_v2.0_emmc/prj_sc4236/prj_sc4236.runs/fifo_maxtrix_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_maxtrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_maxtrix.tcl
